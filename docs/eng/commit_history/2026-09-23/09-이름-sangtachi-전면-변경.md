...
|------|:---:|
| `2026-09-23/04-phase1-endpoint-args.md` (kor, eng) | 1 each (1 line) |
| `2026-09-23/07-phase1-event-loop.md` (kor, eng) | 1 each (1 line) |
| `2026-09-23/03-phase1-빌드-뼈대.md` (kor, eng) | 6 each (4 lines) |
