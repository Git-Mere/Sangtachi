...
The diagnosis is in the same-day record `2026-09-21-docgate.md`. In short,
`2026-09-21-windows-prereq` took 31 rounds and 73 findings, and **32 of them came from two
