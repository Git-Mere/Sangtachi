...
was added in [`2026-09-18/01-nat-probe.md`](../2026-09-18/01-nat-probe.md). Both showed up on a real
Windows run.
...
`2026-09-18/01-nat-probe.md` still applies. The measurement JSON and the 2 records are still not
